...
use App\User\Repository\EmailPasswordResetTokenRepository;
use Doctrine\ORM\Mapping as ORM;
use DateTimeInterface;

/**
 * @ORM\Entity(repositoryClass=EmailPasswordResetTokenRepository::class)
 * @ORM\HasLifecycleCallbacks
 */
class EmailPasswordResetToken
{
    /**
     * @ORM\Id
     * @ORM\GeneratedValue
